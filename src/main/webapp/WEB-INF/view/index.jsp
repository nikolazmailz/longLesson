...
<html>
<head>
  <title>Long Lessons</title>
  <%--<spring:url value="/webjars/bootstrap/3.3.7/css/bootstrap.css" var="bootstrap"/>--%>
  <%--<spring:url value="/webjars/bootstrap/3.3.7/css/modern-business.css" var="startertemplate"/>--%>
  <%--<link href="${bootstrap}" rel="stylesheet" />--%>
  <%--<link href="${startertemplate}" rel="stylesheet" />--%>

  <script type="text/javascript" src="/webjars/jquery/1.11.1/jquery.js" ></script>
  <%--<script type="text/javascript" src="/webjars/jqgrid/4.7.0/js/minified/jquery.jqGrid.min.js" ></script>--%>
  <%--<script type="text/javascript" src="/webjars/jqgrid/4.7.0/js/i18n/grid.locale-ru.js" ></script>--%>
  ...
  <%--<link rel="stylesheet" type="text/css" media="screen" href="/webjars/jquery-ui/1.12.1/jquery-ui.theme.min.css">--%>
  <link rel="stylesheet" type="text/css" media="screen" href="/webjars/bootstrap/3.3.6/css/bootstrap.css" />
